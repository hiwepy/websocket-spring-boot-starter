...
public abstract class AbstractPathMatchEventHandler<T extends WebSocketMessageEvent> extends AbstractAdviceEventHandler<T>  implements PathProcessor<T> {
	...
	@Override
	public WebSocketMessageHandler<T> processPath(String path) {
